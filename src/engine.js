...
class CryptoBotFinal {
  ...
  evaluate(){
    // No-op: engine viejo desactivado. Solo simpleBot genera señales.
    // Preservamos: tick, régimen, equity, F&G para dashboard y endpoints.
    ...
    return{signals:[],newTrades:[],circuitBreaker:this.breaker.check(tv),optimizerResult:null,drawdownAlert:null};
  }
  getState(){
